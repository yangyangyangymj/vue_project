  ...
  <div>
    <el-dialog :title="info.title" :visible.sync="info.show">
      <el-form :model="form" :rules="rules" ref="form">
        <el-form-item label="菜单名称" prop="title" label-width="80px">
        ...
        <el-form-item label="菜单类型" label-width="80px">
          <el-radio v-model="form.type" :label="1" value>目录</el-radio>
          <el-radio v-model="form.type" :label="2" value>菜单</el-radio>
        </el-form-item>
